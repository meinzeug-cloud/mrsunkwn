...
export const AITutorChat: React.FC<AITutorChatProps> = ({
  ...
  const [preferences, setPreferences] = useLocalStorage(`aitutorchat_preferences`, {
    theme: 'student',
    difficultyLevel: 5,
    preferredSubjects: [],
  ...
  // Main render
  return (
    <div className={`mrs-unkwn-aitutorchat theme-${theme} ${className}`}>
      <div className="component-header">
        <h1>Mrs-Unkwn - AITutorChat</h1>
