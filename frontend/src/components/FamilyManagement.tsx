...
export const FamilyManagement: React.FC<FamilyManagementProps> = ({
  ...
  const [preferences, setPreferences] = useLocalStorage(`familymanagement_preferences`, {
    theme: 'student',
    difficultyLevel: 5,
    preferredSubjects: [],
  ...
  // Main render
  return (
    <div className={`mrs-unkwn-familymanagement theme-${theme} ${className}`}>
      <div className="component-header">
        <h1>Mrs-Unkwn - FamilyManagement</h1>
