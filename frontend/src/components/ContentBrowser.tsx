...
export const ContentBrowser: React.FC<ContentBrowserProps> = ({
  ...
  const [preferences, setPreferences] = useLocalStorage(`contentbrowser_preferences`, {
    theme: 'student',
    difficultyLevel: 5,
    preferredSubjects: [],
  ...
  // Main render
  return (
    <div className={`mrs-unkwn-contentbrowser theme-${theme} ${className}`}>
      <div className="component-header">
        <h1>Mrs-Unkwn - ContentBrowser</h1>
