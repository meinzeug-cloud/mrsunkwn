...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  const apiEndpoint = useMemo(() => {
    const baseUrl = userId ? `/api/dashboards/user/${userId}` : `/api/dashboards`;
    ...
    if (loading) {
      return (
        <div className="loading-container">
          <div className="loading-spinner">Loading dashboards...</div>
        </div>
      );
    }
      ...
      return (
        <div className="error-container">
          <div className="error-message">
            <h4>Error loading dashboards</h4>
            <p>{error.message}</p>
      ...
      return (
        <div className="empty-state">
          <div className="empty-message">
            ...
            <p>{state.searchQuery ? 'Try adjusting your search' : 'Get started by creating your first dashboard'}</p>
          </div>
        </div>
      );
    }
  ...
  return (
    <div 
      ref={containerRef}
      className={`dashboard-component theme-${theme} size-${size} variant-${variant} ${className}`}
